...
import org.arguside.debug.internal.model.MethodClassifier
...
class DebuggerPreferencePage extends FieldEditorPreferencePage(FieldEditorPreferencePage.GRID) with IWorkbenchPreferencePage {
  ...
  setPreferenceStore(ArgusDebugPlugin.plugin.getPreferenceStore)
...
object DebuggerPreferencePage {
  ...
  val HotCodeReplaceEnabled = "org.argus-ide.cit.debug.hcr.enabled"
  val NotifyAboutFailedHcr = "org.argus-ide.cit.debug.hcr.notifyFailed"
  val NotifyAboutUnsupportedHcr = "org.argus-ide.cit.debug.hcr.notifyUnsupported"
  val PerformHcrForFilesContainingErrors = "org.argus-ide.cit.debug.hcr.performForFilesContainingErrors"
  val DropObsoleteFramesAutomatically = "org.argus-ide.cit.debug.hcr.dropObsoleteFramesAutomatically"
  val AllowToDropObsoleteFramesManually = "org.argus-ide.cit.debug.hcr.allowToDropObsoleteFramesManually"
}
...
class DebugerPreferencesInitializer extends AbstractPreferenceInitializer {
  ...
  override def initializeDefaultPreferences(): Unit = {
    val store = ArgusDebugPlugin.plugin.getPreferenceStore
