package org.arguside.debug.internal.extensions

import org.arguside.util.eclipse.EclipseUtils
import org.arguside.debug.DebugEventHandler

object EventHandlerMapping {

  final val EventHandlerId = "org.argus-ide.cit.debug.eventHandler"
