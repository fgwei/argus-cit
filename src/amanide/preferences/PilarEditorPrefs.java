...
import amanide.utils.LinkFieldEditor;
...
public class PilarEditorPrefs extends AbstractPilarEditorPrefs {
    ...
    protected Control createAppearancePage(Composite parent) {
        ...
        updateLabelExample(PilarFormatStd.getFormat(), AmanIDEPrefs.getChainedPrefStore());
    ...
    public void dispose() {
        ...
        if (updateLabelExampleOnPrefsChanges != null) {
            AmanIDEPrefs.getChainedPrefStore().removePropertyChangeListener(updateLabelExampleOnPrefsChanges);
    ...
    public void setUpdateLabelExampleOnPrefsChanges() {
        ...
        AmanIDEPrefs.getChainedPrefStore().addPropertyChangeListener(updateLabelExampleOnPrefsChanges);
