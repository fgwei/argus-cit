...
public class TreeNode<T> {
	...
	/**
	 * Note: children of a class don't necessarily have the same type as the
	 * parent.
	 */
	...
	protected void fillBuf(TreeNode<T> treeNode, FastStringBuffer buf, int level) {
		buf.appendN("    ", level).append("TreeNode:")
				.appendObject(treeNode.data).append('\n');
	...
	public <Y> List<TreeNode<Y>> flatten() {
		ArrayList<TreeNode<Y>> array = new ArrayList<TreeNode<Y>>(this
				.getChildren().size() + 10);
