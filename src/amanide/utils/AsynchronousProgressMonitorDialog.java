...
/**
 * This class overrides the ProgressMonitorDialog to limit the number of task
 * name changes in the GUI.
 *
 * @author rickard
 */
		...
		synchronized (updateStatusLock) {
			if (updateStatus == null) {
				updateStatus = new Runnable() {
					...
					public void run() {
						try {
							IProgressMonitor monitor = AsynchronousProgressMonitorDialog.super
									.getProgressMonitor();
