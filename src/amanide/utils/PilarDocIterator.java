...
public class PilarDocIterator implements Iterator<String> {
    ...
    public PilarDocIterator(IDocument doc, boolean addNewLinesToRet) {
        this(doc, addNewLinesToRet, false, false);
    }

    public PilarDocIterator(IDocument doc, boolean addNewLinesToRet, boolean returnNewLinesOnLiterals,
    ...
    public PilarDocIterator(IDocument doc) {
        this.doc = doc;
    }
