...
// * @author Fabio Zadrozny
// */
//public final class ASTManager extends AbstractASTManager implements
...
//
//	/**
//	 * @return modules manager wrapped cast to the interface we expect. Creates
//	 *         it if needed.
//	 */
...
//
//	@Override
//	public void changePythonPath(String pythonpath, final IProject project,
//			IProgressMonitor monitor) {
//		getProjectModulesManager().changePythonPath(pythonpath, project,
//				monitor);
//	}
//
//	public void rebuildModule(File f, ICallback0<IDocument> doc,
//			final IProject project, IProgressMonitor monitor,
//			IPilarNature nature) {
//		getProjectModulesManager().rebuildModule(f, doc, project, monitor,
//				nature);
//	}
//
//	@Override
...
//				.loadFromFile(projectModulesManager, astOutputFile);
