...
import iamandroid.utils.FontUtils;
import iamandroid.utils.IFontUsage;
...
public class StyledTextForShowingCodeFactory implements IPropertyChangeListener {
    ...
    public StyledText createStyledTextForCodePresentation(Composite parent) {
        ...
        AmandroidPrefs.getChainedPrefStore().addPropertyChangeListener(this);
    ...
    private void updateBackgroundColor() {
        IPreferenceStore chainedPrefStore = AmandroidPrefs.getChainedPrefStore();
     ...
     */
    public void dispose() {
        AmandroidPrefs.getChainedPrefStore().removePropertyChangeListener(this);
