 ...
 */
package iamandroid.editors.autoedit;

import iamandroid.AmandroidPlugin;
import iamandroid.cache.PilarPreferencesCache;
...
public class DefaultIndentPrefs extends AbstractIndentPrefs {
    ...
    private PilarPreferencesCache getCache() {
        if (cache == null) {
            cache = new PilarPreferencesCache(AmandroidPlugin.getDefault().getPreferenceStore());
        }
        return cache;
    }
    ...
    public static int getStaticTabWidth() {
        AmandroidPlugin default1 = AmandroidPlugin.getDefault();
        if (default1 == null) {
            return 4;
        }
