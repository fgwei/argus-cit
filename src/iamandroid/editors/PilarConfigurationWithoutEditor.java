...
//  }
  ...
  protected IDialogSettings getSettings(String sectionName) {
      IDialogSettings settings = AmandroidPlugin.getDefault().getDialogSettings().getSection(sectionName);
      if (settings == null) {
          settings = AmandroidPlugin.getDefault().getDialogSettings().addNewSection(sectionName);
      }
