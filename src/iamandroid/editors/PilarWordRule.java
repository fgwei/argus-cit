 ...
 * @see IWordDetector
 */
public class PilarWordRule implements IRule {
     ...
     */
    public PilarWordRule(IWordDetector detector, IToken defaultToken, IToken classNameToken, IToken funcNameToken,
        ...
        this.recordNameToken = classNameToken;
        this.procedureNameToken = funcNameToken;
    ...
    public IToken evaluate(ICharacterScanner scanner) {
        ...
        switch (c) {
            ...
            case ':':
            		c = scanner.read();
            		if(c == '=') found = this.operatorsToken;
            		break;
            case '<':
            case '>':
            case '=':
        ...
        if (fDetector.isWordStart((char) c)) {
            if (fColumn == UNDEFINED || (fColumn == scanner.getColumn() - 1)) {
                ...
                if (lastFound.equals("procedure")) {
                    lastFound = "procedure1";
                } else if (lastFound.equals("procedure1")){
                		lastFound = str;
                		return procedureNameToken;
                }
                
                if (lastFound.equals("record")) {
                    lastFound = str;
                    return recordNameToken;
                }
