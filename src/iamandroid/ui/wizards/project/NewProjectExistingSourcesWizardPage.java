...
import iamandroid.ui.wizards.files.AmandroidExistingSourceListGroup;
...
public class NewProjectExistingSourcesWizardPage extends AbstractNewProjectPage
    ...
    private AmandroidExistingSourceListGroup group;
    ...
    public void createControl(Composite parent) {
        ...
        group = new AmandroidExistingSourceListGroup(composite, new SelectionListener() {
    ...
    public boolean isPageComplete() {
        ...
        if (((AmandroidProjectWizard) getWizard()).projectPage.getSourceFolderConfigurationStyle() != IWizardNewProjectNameAndLocationPage.AMANDROID_NEW_PROJECT_EXISTING_SOURCES) {
            return true;
        }
