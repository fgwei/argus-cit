...
public interface IWizardNewProjectNameAndLocationPage extends IWizardPage {
    ...
    public static final String AMANDROID_NEW_PROJECT_CREATE_PREFERENCES = "AMANDROID_NEW_PROJECT_CREATE_PREFERENCES";

    final int AMANDROID_NEW_PROJECT_CREATE_SRC_FOLDER = 0; //also the default
    final int AMANDROID_NEW_PROJECT_CREATE_PROJECT_AS_SRC_FOLDER = 1;
    final int AMANDROID_NEW_PROJECT_EXISTING_SOURCES = 2;
    final int AMANDROID_NEW_PROJECT_NO_PATH = 3;
