...
//    }
    ...
    private final class WorkingSetGroup {
        ...
        public WorkingSetGroup() {
            ...
            fWorkingSetBlock = new WorkingSetConfigurationBlock(workingSetIds, AmandroidPlugin.getDefault()
                    .getDialogSettings());
        }
    ...
    public NewProjectNameAndLocationWizardPage(String pageName) {
        ...
        setDescription("Create a new Amandroid Project.");
    ...
    public void createControl(Composite parent) {
        ...
        IPreferenceStore preferences = AmandroidPrefs.getPreferences();
        int srcFolderCreate = preferences
                .getInt(IWizardNewProjectNameAndLocationPage.AMANDROID_NEW_PROJECT_CREATE_PREFERENCES);
        switch (srcFolderCreate) {
            case AMANDROID_NEW_PROJECT_CREATE_PROJECT_AS_SRC_FOLDER:
                projectAsSrcFolder.setSelection(true);
                break;

            case AMANDROID_NEW_PROJECT_EXISTING_SOURCES:
                exSrcFolder.setSelection(true);
                break;

            case AMANDROID_NEW_PROJECT_NO_PATH:
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.widget == checkSrcFolder) {
                    ...
                    if (checkSrcFolder.getSelection()) {
                        preferences.setValue(IWizardNewProjectNameAndLocationPage.AMANDROID_NEW_PROJECT_CREATE_PREFERENCES,
                                AMANDROID_NEW_PROJECT_CREATE_SRC_FOLDER);
                        setPageComplete(validatePage());
                    }
                }
            }
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.widget == projectAsSrcFolder) {
                    ...
                    if (projectAsSrcFolder.getSelection()) {
                        preferences.setValue(IWizardNewProjectNameAndLocationPage.AMANDROID_NEW_PROJECT_CREATE_PREFERENCES,
                                AMANDROID_NEW_PROJECT_CREATE_PROJECT_AS_SRC_FOLDER);
                        setPageComplete(validatePage());
                    }
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.widget == exSrcFolder) {
                    ...
                    if (exSrcFolder.getSelection()) {
                        preferences.setValue(IWizardNewProjectNameAndLocationPage.AMANDROID_NEW_PROJECT_CREATE_PREFERENCES,
                                AMANDROID_NEW_PROJECT_EXISTING_SOURCES);
                        setPageComplete(validatePage());
                    }
                }
            }
...
//        createdOn.setLayoutData(data);
    ...
    public IProject getProjectHandle() {
        return AmandroidStructureConfigHelpers.getProjectHandle(getProjectName());
    }
...
//        PilarFileListing pyFileListing = PythonPathHelper.getModulesBelow(locFile, null);
...
//        }
    ...
    public int getSourceFolderConfigurationStyle() {
        ...
        switch (srcFolderCreate) {
            ...
            case AMANDROID_NEW_PROJECT_CREATE_PROJECT_AS_SRC_FOLDER:
                return AMANDROID_NEW_PROJECT_CREATE_PROJECT_AS_SRC_FOLDER;
            case AMANDROID_NEW_PROJECT_EXISTING_SOURCES:
                return AMANDROID_NEW_PROJECT_EXISTING_SOURCES;
            case AMANDROID_NEW_PROJECT_NO_PATH:
                return AMANDROID_NEW_PROJECT_NO_PATH;

            default:
                return AMANDROID_NEW_PROJECT_CREATE_SRC_FOLDER;
        }
    }
    ...
    public IWizardPage getNextPage() {
        AmandroidProjectWizard wizard = (AmandroidProjectWizard) getWizard();
        if (getSourceFolderConfigurationStyle() == IWizardNewProjectNameAndLocationPage.AMANDROID_NEW_PROJECT_EXISTING_SOURCES) {
