...
public class InformationPresenterHelpers {
    ...
    public static class TooltipInformationControlCreator implements IInformationControlCreator {
        ...
        public IInformationControl createInformationControl(Shell parent) {
            ...
            PilarInformationControl tooltip = new PilarInformationControl(null, tooltipAffordanceString, presenter);
            return tooltip;
        }

    }

    public final static class PilarInformationControl extends DefaultInformationControl implements
            IInformationControlExtension3 {
        public PilarInformationControl(Shell parent, String statusFieldText, IInformationPresenter presenter) {
