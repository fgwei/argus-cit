...
public interface IModule {
    ...
    public abstract boolean isInGlobalTokens(String tok, IPilarNature nature, ICompletionCache completionCache)
     ...
     * @throws CompletionRecursionException 
     */
    public abstract boolean isInGlobalTokens(String tok, IPilarNature nature, boolean searchSameLevelMods,
     ...
     * @throws CompletionRecursionException 
     */
    public int isInGlobalTokens(String tok, IPilarNature nature, boolean searchSameLevelMods,
     ...
     * @throws Exception
     */
    public abstract IDefinition[] findDefinition(ICompletionState state, int line, int col, IPilarNature nature)
            throws Exception;
