...
import iamandroid.callbacks.ICallback0;
import iamandroid.natures.IPilarNature;
import iamandroid.utils.CompletionRecursionException;
import iamandroid.utils.ImmutableTuple;
...
public interface ICodeCompletionASTManager {
     ...
     */
    public abstract void setProject(IProject project, IPilarNature nature, boolean restoreDeltas);
    ...
    public abstract void rebuildModule(final File file, final ICallback0<IDocument> doc, final IProject project,
            IProgressMonitor monitor, IPilarNature nature);
     ...
     */
    public abstract IPilarNature getNature();
     ...
     */
    public abstract IModule getModule(String name, IPilarNature nature, boolean dontSearchInit,
     ...
     * @throws CompletionRecursionException 
     */
    public IToken getRepInModule(IModule module, String tokName, IPilarNature nature)
            throws CompletionRecursionException;
