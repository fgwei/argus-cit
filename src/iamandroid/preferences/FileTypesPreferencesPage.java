...
import iamandroid.ui.utils.LabelFieldEditorWith2Cols;
import iamandroid.utils.StringUtils;
import iamandroid.utils.WrapAndCaseUtils;
...
public class FileTypesPreferencesPage extends FieldEditorPreferencePage implements IWorkbenchPreferencePage {
    ...
    public final static String DEFAULT_FIRST_CHOICE_PILAR_SOURCE_FILE = "plr";
    ...
    protected void createFieldEditors() {
        ...
        addField(new StringFieldEditor(FIRST_CHOICE_PILAR_SOURCE_FILE, "Default pilar extension:",
                StringFieldEditor.UNLIMITED, p));
    }
    ...
    private static class PreferencesCacheHelper implements IPropertyChangeListener {
        ...
        public PreferencesCacheHelper() {
            AmandroidPrefs.getPreferences().addPropertyChangeListener(this);
        }
...
//        }
        ...
        public String[] getCacheValidSourceFiles() {
            ...
            if (ret == null) {
                String validStr = AmandroidPrefs.getPreferences().getString(FileTypesPreferencesPage.VALID_SOURCE_FILES);
    ...
    public final static String getDefaultDottedPilarExtension() {
        return "." + AmandroidPrefs.getPreferences().getString(FIRST_CHOICE_PILAR_SOURCE_FILE);
    }

    public static String[] getWildcardPythonValidZipFiles() {
        return new String[] { "*.apk", "*.jar" };
    }
