...
public abstract class AbstractPilarEditorPrefs extends PreferencePage implements IWorkbenchPreferencePage {
...
//    public static final boolean DEFAULT_AUTO_ADD_SELF = true;
    ...
    public static final RGB DEFAULT_ANNOTATION_COLOR = new RGB(125, 125, 125);
    
    public static final String LOC_COLOR = "LOC_COLOR";
    public static final RGB DEFAULT_LOC_COLOR = new RGB(128, 0, 0);
    ...
    public static final String RECORD_NAME_COLOR = "RECORD_NAME_COLOR";
    public static final RGB DEFAULT_RECORD_NAME_COLOR = new RGB(0, 0, 0);

    public static final String PROCEDURE_NAME_COLOR = "PROCEDURE_NAME_COLOR";
    public static final RGB DEFAULT_PROCEDURE_NAME_COLOR = new RGB(0, 0, 0);
...
//    public static final boolean DEFAULT_KILL_SUBPROCESSES_WHEN_TERMINATING_PROCESS = true;
    ...
    //font
    public static final String ANNOTATION_STYLE = "ANNOTATION_STYLE";
    public static final int DEFAULT_ANNOTATION_STYLE = SWT.ITALIC;
    
    public static final String LOC_STYLE = "LOC_STYLE";
    public static final int DEFAULT_LOC_STYLE = SWT.ITALIC;
    ...
    public static final String RECORD_NAME_STYLE = "RECORD_NAME_STYLE";
    public static final int DEFAULT_RECORD_NAME_STYLE = SWT.BOLD;

    public static final String PROCEDURE_NAME_STYLE = "PROCDURE_NAME_STYLE";
    public static final int DEFAULT_PROCEDURE_NAME_STYLE = SWT.BOLD;
    ...
    protected final String[][] fAppearanceColorListModel = new String[][] { { "Code", CODE_COLOR, null },
            { "Annotations", ANNOTATION_COLOR, null }, {"#xxxx.", LOC_COLOR, null}, { "Numbers", NUMBER_COLOR, null },
            ...
            { "Record Name", RECORD_NAME_COLOR, null },
            { "Procedure Name", PROCEDURE_NAME_COLOR, null }, { "(), [], {}", PARENS_COLOR, null },
            { "Operators (+,-,*,...)", OPERATORS_COLOR, null }, };

    protected final String[][] fAppearanceFontListModel = new String[][] { { "Code", CODE_STYLE, null },
            { "Annotations", ANNOTATION_STYLE, null }, {"#xxxx.", LOC_STYLE, null}, { "Numbers", NUMBER_STYLE, null },
            ...
            { "Record Name", RECORD_NAME_STYLE, null },
            { "Procedure Name", PROCEDURE_NAME_STYLE, null }, { "(), [], {}", PARENS_STYLE, null },
...
//        overlayKeys.add(new OverlayPreferenceStore.OverlayKey(OverlayPreferenceStore.BOOLEAN, AUTO_ADD_SELF));
        ...
        overlayKeys.add(new OverlayPreferenceStore.OverlayKey(OverlayPreferenceStore.STRING, ANNOTATION_COLOR));
        overlayKeys.add(new OverlayPreferenceStore.OverlayKey(OverlayPreferenceStore.STRING, LOC_COLOR));
...
//        overlayKeys.add(new OverlayPreferenceStore.OverlayKey(OverlayPreferenceStore.STRING, BACKQUOTES_COLOR));
        overlayKeys.add(new OverlayPreferenceStore.OverlayKey(OverlayPreferenceStore.STRING, RECORD_NAME_COLOR));
        overlayKeys.add(new OverlayPreferenceStore.OverlayKey(OverlayPreferenceStore.STRING, PROCEDURE_NAME_COLOR));
        ...
        overlayKeys.add(new OverlayPreferenceStore.OverlayKey(OverlayPreferenceStore.INT, ANNOTATION_STYLE));
        overlayKeys.add(new OverlayPreferenceStore.OverlayKey(OverlayPreferenceStore.INT, LOC_STYLE));
...
//        overlayKeys.add(new OverlayPreferenceStore.OverlayKey(OverlayPreferenceStore.INT, BACKQUOTES_STYLE));
        overlayKeys.add(new OverlayPreferenceStore.OverlayKey(OverlayPreferenceStore.INT, RECORD_NAME_STYLE));
        overlayKeys.add(new OverlayPreferenceStore.OverlayKey(OverlayPreferenceStore.INT, PROCEDURE_NAME_STYLE));
    ...
    public boolean performOk() {
        ...
        AmandroidPlugin.getDefault().savePluginPreferences();
        return true;
    }
