...
public class PilarPreferencesCache implements IPropertyChangeListener {

    private IPreferenceStore preferenceStore;
    private HashMap<String, Object> cache = new HashMap<String, Object>();

    public PilarPreferencesCache(IPreferenceStore preferenceStore) {
