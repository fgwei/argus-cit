...
import org.arguside.core.internal.extensions.saveactions.AddMissingOverrideCreator
import org.arguside.core.internal.extensions.saveactions.AddNewLineAtEndOfFileCreator
import org.arguside.core.internal.extensions.saveactions.AddReturnTypeToPublicSymbolsCreator
import org.arguside.core.internal.extensions.saveactions.AutoFormattingCreator
import org.arguside.core.internal.extensions.saveactions.RemoveDuplicatedEmptyLinesCreator
import org.arguside.core.internal.extensions.saveactions.RemoveTrailingWhitespaceCreator
import org.arguside.core.internal.jdt.model.ArgusSourceFile
import org.arguside.core.internal.text.TextDocument
import org.arguside.core.text.Change
import org.arguside.core.text.TextChange
import org.arguside.extensions.CompilerSupport
import org.arguside.extensions.SaveAction
import org.arguside.extensions.SaveActionSetting
import org.arguside.extensions.saveactions.AddMissingOverrideSetting
import org.arguside.extensions.saveactions.AddNewLineAtEndOfFileSetting
import org.arguside.extensions.saveactions.AddReturnTypeToPublicSymbolsSetting
import org.arguside.extensions.saveactions.AutoFormattingSetting
import org.arguside.extensions.saveactions.RemoveDuplicatedEmptyLinesSetting
import org.arguside.extensions.saveactions.RemoveTrailingWhitespaceSetting
...
trait SaveActionExtensions extends HasLogger {
  ...
  private[this] var lastSourceFile: ArgusSourceFile = _
   ...
   */
  def createArgusSaveActionListener(udoc: IDocument): IPostSaveListener = {
    new IPostSaveListener {
      override def getName = "ArgusSaveActions"
      override def getId = "ArgusSaveActions"
  ...
  private def applySaveActions(udoc: IDocument): Unit = {
    ...
    EditorUtils.withArgusSourceFileAndSelection { (ssf, sel) =>
      lastSourceFile = ssf
      lastSelection = sel
