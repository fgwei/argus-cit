...
import org.arguside.ui.internal.editor.decorators.BaseSemanticAction
import org.arguside.core.internal.compiler.ArgusPresentationCompiler
import org.arguside.ui.internal.preferences.CallByNameParamCreationPreferencePage
...
final class CallByNameParamAtCreationPresenter(sourceViewer: ISourceViewer) extends
  ...
  protected override def findAll(compiler: ArgusPresentationCompiler, scu: ArgusCompilationUnit, sourceFile: SourceFile): Map[Annotation, Position] =
...
object CallByNameParamAtCreationPresenter extends HasLogger {
   ...
   */
  def findByNameParamCreations(compiler: IArgusPresentationCompiler, scu: ArgusCompilationUnit, sourceFile: SourceFile, firstLineOnly: Boolean = prefStoreCfg): Map[Annotation, Position] = {
