...
class ArgusAutoIndentStrategy(
  ...
  private def createIndenter(d : IDocument, scanner : JavaHeuristicScanner) : ArgusIndenter = {
    return new ArgusIndenter(d, scanner, fProject, preferencesProvider)
  }
