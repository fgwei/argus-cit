...
trait EclipseSettings {
  self: ArgusPluginPreferencePage =>
   ...
   */
  private class CheckBoxSettingWithDefault(setting: ArgusPluginSettings.BooleanSettingWithDefault) extends EclipseSetting(setting) {
    var control: Button = _
