...
import org.arguside.core.internal.builder.ProjectsCleanJob
...
import argus.tools.nsc.settings.ScalaVersion
import argus.tools.nsc.settings.SpecificScalaVersion
import argus.tools.nsc.settings.Final
import org.eclipse.jface.preference.StringFieldEditor
import org.arguside.core.internal.project.ScalaInstallation
import org.arguside.ui.internal.project.ScalaInstallationUIProviders
import org.arguside.core.internal.project.ScalaInstallationChoice
...
trait ArgusPluginPreferencePage extends HasLogger {
...
class CompilerSettings extends PropertyPage with IWorkbenchPreferencePage with EclipseSettings
  ...
  override def doGetPreferenceStore(): IPreferenceStore = {
    ArgusPlugin().getPreferenceStore()
  }
  ...
  def save(): Unit = {
    ...
    val project = getConcernedProject()
    val scalaProject = project flatMap (ArgusPlugin().asScalaProject(_))
