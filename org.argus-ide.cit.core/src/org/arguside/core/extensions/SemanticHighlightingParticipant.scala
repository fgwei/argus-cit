...
import org.arguside.ui.internal.editor.decorators.SemanticAction
 ...
 *
 * `participant` needs to create a [[org.arguside.ui.internal.editor.decorators.SemanticAction]]
