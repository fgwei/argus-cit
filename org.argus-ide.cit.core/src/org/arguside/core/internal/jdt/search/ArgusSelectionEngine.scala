...
import org.arguside.core.internal.jdt.model.ArgusLocalVariableElement
import org.arguside.core.compiler.IArgusPresentationCompiler.Implicits._

class ArgusSelectionEngine(nameEnvironment: SearchableEnvironment, requestor: ArgusSelectionRequestor, settings: ju.Map[_, _]) extends Engine(settings) with ISearchRequestor with HasLogger {
