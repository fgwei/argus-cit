...
trait ScalaStructureBuilder extends ScalaAnnotationHelper { pc : ArgusPresentationCompiler =>
  ...
  class StructureBuilderTraverser(scu : ArgusCompilationUnit, unitInfo : OpenableElementInfo, newElements0 : JMap[AnyRef, AnyRef], sourceLength : Int) {
