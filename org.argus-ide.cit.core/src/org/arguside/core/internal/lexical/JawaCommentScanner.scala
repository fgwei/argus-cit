 ...
 * which can't be directly used because it doesn't extend [[AbstractArgusScanner]].
 ...
 * This means that all task tags configured for the Java editor also work for the Argus
