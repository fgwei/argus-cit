...
import org.arguside.ui.internal.preferences.ResourcesPreferences

/**
 * Tracks activity of JawaPresentationCompiler and shuts it down if it's unused sufficiently long
