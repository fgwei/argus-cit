...
class EditorPreferencePage extends PreferencePage with IWorkbenchPreferencePage {
  ...
  private val store = IArgusPlugin().getPreferenceStore()
  ...
  private def createSettingsGroup(base: Composite): Unit = {
    ...
    checkBox(P_ENABLE_AUTO_CLOSING_COMMENTS, "Automatically close multi line comments and Jawadoc", typing)
  ...
  import org.arguside.util.eclipse.SWTUtils.CheckBox
