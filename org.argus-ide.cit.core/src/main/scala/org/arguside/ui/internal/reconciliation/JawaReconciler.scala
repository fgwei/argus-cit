...
import org.arguside.core.internal.compiler.PresentationCompilerActivity
...
import org.arguside.core.internal.compiler.Restart

/** A Jawa reconciler that forces reconciliation on various events:
 ...
 */
class JawaReconciler(editor: InteractiveCompilationUnitEditor,
  ...
  override def install(textViewer: ITextViewer): Unit = {
    ...
    compilerProxy = editor.getInteractiveCompilationUnit().argusProject.presentationCompiler
    compilerProxy match {
